...
package com.autoai.wiredprojection.common;
...
public class StateMachine {
    ...
    protected final void clearDeferredMessages() {
        if (mSmHandler == null) return;
        mSmHandler.mDeferredMessages.clear();
    }
    ...
    protected final void removeMessages(int what, Object object) {
        SmHandler smh = mSmHandler;
        if (smh ==  null) return;
    ...
    protected final void removeDeferredMessages(int what, Object object) {
        SmHandler smh = mSmHandler;
        if (smh == null) return;
        ...
        while (iterator.hasNext()) {
            Message msg = iterator.next();
            if (msg.what == what && msg.obj == object) iterator.remove();
        }
    }
    ...
    protected final boolean hasDeferredMessages(int what, Object object) {
        SmHandler smh = mSmHandler;
        if (smh == null) return false;
        ...
        while (iterator.hasNext()) {
            Message msg = iterator.next();
            if (msg.what == what && msg.obj == object) return true;
        }
    ...
    protected final boolean hasMessages(int what, Object object) {
        SmHandler smh = mSmHandler;
        if (smh == null) return false;
